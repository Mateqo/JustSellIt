...
namespace JustSellIt.Infrastructure.Migrations
{
    ...
    [Migration("20210219190556_AddRejectionReason")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JustSellIt.Domain.Model.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JustSellIt.Domain.Model.OwnerContact", b =>
                {
                    ...
                    b.ToTable("OwnersContact");
                });

            modelBuilder.Entity("JustSellIt.Domain.Model.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("RejectionReasonId")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int?>("RejectionReasonId1")
                        .HasColumnType("int");

                    b.Property<bool>("StorePolicy")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("JustSellIt.Domain.Model.RejectionReason", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("JustSellIt.Domain.Model.OwnerContact", b =>
                {
                    b.HasOne("JustSellIt.Domain.Model.Owner", "Owner")
                        .WithOne("OwnerContact")
                        .HasForeignKey("JustSellIt.Domain.Model.OwnerContact", "OwnerRef")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JustSellIt.Domain.Model.Product", b =>
                {
                    b.HasOne("JustSellIt.Domain.Model.Category", "Category")
                        .WithMany("Products")
                    ...
                    b.HasOne("JustSellIt.Domain.Model.RejectionReason", "RejectionReason")
                        .WithMany("Products")
                        .HasForeignKey("RejectionReasonId1");
